  ...
  <section class="product-slider">
    ...
    <div class="card">
      <div
        ...
        :style="
          'background:url(' +
          require('@/assets/images/' + data.backgrounds[slideIndex] + '.jpg') +
          ')'
        "
      ></div>
      <div class="panel-2"></div>
      <ProductDetails :data="data" :slideIndex="slideIndex" :count="count" :active="active" />
      <div
        class="arrow-left"
        @click="
          count = 0
...
export default {
  ...
  data() {
    return {
      ...
      active: 4,
      data: {
        images: ['yellow.jpg', 'white', 'red', 'purple', 'pink', 'navy'],
        names: ['j1', 'j2', 'j3', 'j4', 'j5', 'j6'],
        prices: ['1', '2', '3', '4', '5', '6'],
        optionTitles: ['service', 'ser', 'serv', 'servi', 'servic', 'seice'],
        options: [
          ['a', 'z'],
          ['b', 'x'],
          ['c', 'g'],
