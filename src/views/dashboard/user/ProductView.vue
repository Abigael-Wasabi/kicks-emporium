<template>
  <v-layout>
    ...
    <v-main>
        ...
        <tbody>
          <tr v-for="(product, index) in products" :key="index">
            ...
            <td class="border border-gray-300 px-4 py-2">
              <button @click="editProduct(product)" class="text-blue-500 hover:text-blue-700 mr-2">
                Edit
              </button>
      ...
      <button
        @click="openAddModal"
        class="mt-4 bg-green-500 hover:bg-green-700 text-slate-900 font-semibold py-2 px-4 rounded"
      >
        Add Product
      </button>
